...
class ResultLotto535View extends StatefulWidget {
  ResultLotto535View({Key? key, required this.powerResults}) : super(key: key);
  List<GetResultResponse> powerResults;
  @override
  State<ResultLotto535View> createState() => _ResultLotto535ViewState();
}

class _ResultLotto535ViewState extends State<ResultLotto535View> {
  @override
