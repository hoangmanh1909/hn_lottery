...
class TicketLotoView extends StatefulWidget {
  const TicketLotoView({Key? key, required this.type, this.code})
      : super(key: key);
  final int type;
  final String? code;
  @override
  State<TicketLotoView> createState() => _TicketLotoState();
}

class _TicketLotoState extends State<TicketLotoView> {
  ...
  next() async {
    ...
    if (mode != Common.ANDROID_MODE_UPLOAD ||
      ...
      return dialogQR(context,
          "${_line.join("|")}|$drafAmount|${getProductName(Common.ID_LOTO235)}");
    }
    ...
    order.productID = Common.ID_LOTO235;
    order.quantity = 1;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Lô tô ${widget.type.toString()} số"),
        leading: IconButton(
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text("Lô tô ${widget.type.toString()} số",
